...
import { groupAcrossDays, sortWithinDay, filterWithRange } from './../fns/event.fns';
...
describe('Event fns', () => {
    ...
    describe('filterByRange', () => {
        const filter = filterWithRange(parse("2017-12-26T13:40:07.361Z"), parse("2017-12-27T16:00:00.000Z"));
        ...
        describe('Combine', () => {
            ...
            it('should filter by two day', () => {
                const filtered = filterWithRange(parse("2017-12-26T13:40:07.361Z"), parse("2017-12-27T16:00:00.000Z"))(gCalEventss);
            ...
            it('should filter by one day', () => {
                const filtered = filterWithRange(parse("2017-12-26T13:40:07.361Z"), parse("2017-12-26T16:00:00.000Z"))(gCalEventss);
                expect(filtered).to.be.deep.equal([
                    {
                        summary: 'In the middle',
                        calendarId: 'abc@gmail.com',
